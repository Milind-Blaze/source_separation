"""Obtains the averages per frame size and then stores them at path store
This is very similar to the combined_graph.py code. Only one line is commented out.
...
parser.add_argument("--path_store", default = "../../experiments/experiment3/largescale/averages", help = "path where all the results of this script are stored")
...
audio_averages_folder = audio_name + "_" + "SNR_averages.pickle"
